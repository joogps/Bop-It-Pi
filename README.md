...
<table> 
	...
	<tr> <td style="padding: 3%"> <b>2.</b> Using a male to female jumper wire, make a connection between any ground pin on your Raspberry Pi and the negative (blue) column on your breadboard. </td> <td width="50%" height="auto" style="padding: 3%"><a href="Circuit/Step2.png"><img src="Circuit/Step2.png" alt="Explanatory image for step 2"></img></a> </td> </tr>
